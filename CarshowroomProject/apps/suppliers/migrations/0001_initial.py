    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='core.carmodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cars_list', models.ManyToManyField(through='suppliers.SupplierCar', to='core.carmodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('percent', models.PositiveSmallIntegerField(default=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ...
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='suppliers.suppliermodel')),
            ],
            options={
